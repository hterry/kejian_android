package com.weiguan.kejian.view.ldrawer;
...
public abstract class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        this.mPaint.setColor(context.getResources().getColor(R.color.blue_divide));
        ...
        this.mPaint.setColor(context.getResources().getColor(R.color.pink_divide));
