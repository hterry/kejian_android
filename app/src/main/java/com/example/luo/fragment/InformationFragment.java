        ...
        if(view == null) {
            ...
            infolist.setXListViewListener(new XListView.IXListViewListener() {
                ...
                public void onRefresh() {
                    StatService.onEvent(getActivity(), Event.EVENT_ID_LISTREFRESH, id == -1 ? "首页" : activity.catIdText.get(id + ""));
                ...
                public void onLoadMore() {
                    if(NetworkUtils.isNetworkAvailable(getActivity())) {
                        if (!isLastRunning) {
                            StatService.onEvent(getActivity(), Event.EVENT_ID_LISTGETMORE, id == -1? "首页" : activity.catIdText.get(id + ""));
                            isLastRunning = true;
